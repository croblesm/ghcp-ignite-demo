...
2. **Run the Demo**: Use the prompts in [`demo-prompts.html`](demo-prompts.html) - open in VS Code and click "Open Preview" 
3. **Detailed Context**: See [`README.copilot.md`](README.copilot.md) for full demo documentation
